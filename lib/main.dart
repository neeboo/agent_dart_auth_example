...
import 'package:agent_dart_auth_example/constant/environments.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<void> initCounter({Identity? identity}) async {
    ...
    counter = Counter(
      ...
      url: isProduction ? 'https://ic0.app' : 'http://localhost:8000',
    );
      ...
      var authClient = WebAuthProvider(
          ...
          authUri: Uri.parse(
            isProduction
                ...
                : 'http://localhost:8000/?canisterId=$iiCanisterId#authorize',
          ),
          useLocalPage: true);
